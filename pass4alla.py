...
FNamn = input("Skriv dit förnamn ")
ENamn = input("Skriv dit efternamn ")
TNummer = input("Skriv dit telefonnummer ")
EPost = input("Skriv din Email ")
...
emailAddress = EPost # Your email
phoneNumber = TNummer # Your phone number
